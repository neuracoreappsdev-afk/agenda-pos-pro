...
<div class="report-container">
    <div class="report-header">
        <h1>Ventas por Tipo de Facturación</h1>
        <div class="breadcrumb">Informes / Ventas / Cumplimiento Legal</div>
    </div>

    <div class="filter-bar">
        <form method="GET" action="{{ url('admin/informes/ventas-tipo-facturacion') }}" class="date-form">
            <div class="group">
                <label>Desde</label>
    ...
    <div class="card-table">
        <div class="card-header">
            <h3>Consolidado por Modalidad de Facturación</h3>
        </div>
        <table class="data-table">
            ...
            <tbody>
                @foreach($data as $row)
                <tr>
                    <td><div style="font-weight:700; color:#111827;">{{ $row->tipo }}</div></td>
                    ...
                    <td>
                        <span style="background:#dcfce7; color:#166534; padding:2px 8px; border-radius:4px; font-size:11px; font-weight:700;">VIGENTE</span>
                    </td>
                </tr>
                @endforeach
            </tbody>
