...
<div class="report-container">
    <div class="report-header">
        ...
        <div class="breadcrumb">Informes / Contabilidad / Exportar Ventas</div>
    </div>

    <div class="filter-bar">
        <form method="GET" action="{{ url('admin/informes/exportar-facturas') }}" class="date-form">
            <div class="group">
                <label>Desde</label>
            ...
            <button type="submit" class="btn-filter">Ver Listado</button>
        ...
        <table class="data-table" id="exportTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $s->customer ? $s->customer->name : 'Venta Rápida' }}</td>
                    <td style="text-align:right; font-weight:800;">$ {{ number_format($s->total, 0) }}</td>
                    <td style="text-align:center;">
                        <span class="status-badge authorized">EMITIDA</span>
                    </td>
                </tr>
                @endforeach
            </tbody>
...
function exportToExcel() {
    ...
    link.download = "export_facturas.xls";
    link.href = url;
    link.click();
}
</script>
