...
@section('config_title', 'Importar Productos')

@section('config_content')
<form action="{{ url('admin/configuration/process-import-products') }}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    
    <div class="config-card">
        <div class="config-section">
            <h3 class="config-section-title">Importar Productos</h3>
            
            <div style="padding: 15px; background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 6px; margin-bottom: 20px;">
                <p style="margin: 0; color: #1e40af; font-size: 14px;">
                    📝 Importe productos desde archivos Excel/CSV con el siguiente formato: Nombre, SKU, Precio, Costo, Cantidad.
