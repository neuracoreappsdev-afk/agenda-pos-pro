...
class Customer extends Model implements AuthenticatableContract{
  ...
  protected $fillable = array(
      'first_name', 'last_name', 'identification', 'id_type', 'dv',
      'contact_number', 'phone_landline', 'email', 'address', 'city', 
      'birthday', 'gender', 'type', 'notes', 'wants_updates',
      'company_name', 'website', 'reference_source_id'
  );
  protected $guarded = array('id', 'created_at', 'updated_at');

  public function referenceSource()
  {
      return $this->belongsTo('App\Models\ReferenceSource', 'reference_source_id');
  }
